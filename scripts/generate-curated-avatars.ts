...
const curatedAvatarSources: Record<string, CuratedAvatarSource> = {
  ...
  "ahmad-awais": {
    kind: "direct",
    url: "https://github.com/AhmadAwais.png?size=512",
    label: "GitHub profile photo",
  },
  "alexander-isora": {
    kind: "direct",
    url: "https://github.com/alexanderisora.png?size=512",
    label: "GitHub profile photo",
  },
  "josh-comeau": {
    kind: "direct",
    url: "https://github.com/joshwcomeau.png?size=512",
    label: "GitHub profile photo",
  },
  "sindre-sorhus": {
    kind: "direct",
    url: "https://github.com/sindresorhus.png?size=512",
    label: "GitHub profile photo",
  },
  "jack-mcdade": {
    kind: "direct",
  ...
  "tanner-linsley": {
    kind: "direct",
    url: "https://github.com/tannerlinsley.png?size=512",
    label: "GitHub profile photo",
  },
  "jason-mccreary": {
    kind: "direct",
    url: "https://github.com/jasonmccreary.png?size=512",
    label: "GitHub profile photo",
  },
  "jeff-geerling": {
    kind: "direct",
    url: "https://github.com/geerlingguy.png?size=512",
    label: "GitHub profile photo",
  },
  "chris-ferdinandi": {
    kind: "direct",
    url: "https://github.com/cferdinandi.png?size=512",
    label: "GitHub profile photo",
  },
  "bastian-allgeier": {
    kind: "direct",
